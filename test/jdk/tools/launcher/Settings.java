...
/*
 * @test
 * @bug 6994753 7123582 8305950 8281658 8310201 8311653 8343804 8351354 8366364 8315487
...
public class Settings extends TestHelper {
    ...
    static void checkServicesAllowed(TestResult tr, boolean servicesAllowed) {
        String noneSvcHdr = "Provider services " + (servicesAllowed ? "NOT " : "") + "allowed: (type : algorithm)";
        ...
        while (oi.hasNext()) {
            if (oi.next().contains(noneSvcHdr)) {
                if (oi.next().contains("<none>")) {
                    ...
                    errorMsg = "Unexpected services listed under '" + noneSvcHdr + "'";
                    break;
                }
            }
        }
    ...
    static void runTestOptionSecurityProv(boolean servicesAllowed) throws IOException {
