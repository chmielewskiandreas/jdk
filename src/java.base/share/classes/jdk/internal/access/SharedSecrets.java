...
public class SharedSecrets {
    ...
    @Stable private static JavaSecurityProviderAccess javaSecurityProviderAccess;
    ...
    public static void setJavaSecurityProviderAccess(JavaSecurityProviderAccess jspa) {
